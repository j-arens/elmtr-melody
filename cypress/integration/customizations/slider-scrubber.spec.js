...
describe('slider scrubber customizations', () => {
    before(() => {
        cy.login('admin', 'z');
        ...
        cy
            .selectTab('style')
            .toggleAccordion('section_slider_scrubber_style');
    });

    it('primary color customization gets applied', () => {
        cy.setColor('#c7c7f9', 'melody_slider_scrubber_primary_color');
    ...
    it('secondary color customization gets applied', () => {
        cy.setColor('#4eb285', 'melody_slider_scrubber_secondary_color');
    ...
    it('handle color customization gets applied', () => {
        cy.setColor('#ff0a0a', 'melody_slider_scrubber_handle_color');
