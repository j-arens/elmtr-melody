...
exports.prepareRules = config => Object.keys(config)
    ...
    pipeline.use(middleware_1.filterRules, middleware_1.assembleBorders, middleware_1.assembleBoxShadows);
