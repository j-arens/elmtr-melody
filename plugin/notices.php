...
function phpVersionNotice() {
    $p1 = __('elementor_melody requires a minimum PHP version of', 'melody');
    $p2 = __('5.6', 'melody');
...
function wpVersionNotice() {
    $p1 = __('elementor_melody requires a minimum WordPress version of', 'melody');
    $p2 = __('4.7', 'melody');
...
function elementorVersionNotice() {
    $p1 = __('elementor_melody requires a minimum Elementor version of', 'melody');
    $p2 = __('1.9.3', 'melody');
